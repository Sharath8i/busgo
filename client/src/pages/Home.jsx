    ...
    <div className="bg-background">
          ...
          <div className="bg-surface-container-lowest p-8 rounded-[2rem] editorial-shadow border border-outline-variant/10">
            <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 items-end">
              ...
              <div className="lg:col-span-1">
                <button 
                  type="submit"
                  className="w-full h-[52px] bg-primary hover:bg-primary-dark text-white rounded-xl font-extrabold text-sm flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-primary/30"
                >
                  Search Routes 🚀
                </button>
              </div>
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {POPULAR_ROUTES.map((route, i) => (
              <div key={i} className="group rounded-[2rem] overflow-hidden bg-surface-container-lowest border border-outline-variant/10 editorial-shadow hover:translate-y-[-8px] transition-all duration-300">
                ...
                <div className="p-8">
                  ...
                  <button 
                    ...
                    className="w-full py-4 bg-surface-container-low text-primary font-bold rounded-xl flex items-center justify-center gap-2 group-hover:bg-primary group-hover:text-white transition-colors"
                  >
                    Book Quick ⚡
                  </button>
                </div>
      ...
      <section className="py-24 px-8 bg-surface-container-low relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto relative z-10">
          ...
          {/* Stats Overlay */}
          <div className="mt-24 bg-surface-container-lowest rounded-[3rem] p-12 editorial-shadow grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
